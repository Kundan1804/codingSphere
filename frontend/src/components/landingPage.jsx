...
const LandingPage = () => {
  ...
  const [allExistingRooms, setAllExistingRooms] = useState([]);
  ...
  const fetchAllExistingRooms = async () => {
    try {
      ...
      setAllExistingRooms(response.data.rooms);
    } catch (error) {
        ...
        <DialogContent sx={{ mt: 2 }}>
          <div style={{
            ...
            <Typography paragraph>
              codingSphere is a real-time collaborative coding platform that enables developers to work together seamlessly. Built with React, Node.js, and MongoDB, it supports live code synchronization, multi-language coding, and code execution. With an integrated chat system, version tracking, and secure room access, codingSphere enhances productivity in an intuitive and responsive environment.
            </Typography>
            <Typography paragraph>
              Key Features:
              <ul>
